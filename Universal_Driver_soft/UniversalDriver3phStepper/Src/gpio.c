...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Brake_Pin|RED_Pin|GREEN_Pin|BLUE_Pin 
                          |IN3_C_Pin|EN_A_B_Pin|RESET_Pin|H_F_Pin 
                          |CW_CCW_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, EN_C_D_Pin|IN4_D_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IN2_B_Pin|IN1_A_Pin|select_Pin|OE_hand_Pin 
                          |OE_step_drv_Pin|CTRL_Pin|EN_Pin|CS_Pin 
  ...
  GPIO_InitStruct.Pin = EN_C_D_Pin|IN4_D_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin 
                           ...
                           PBPin */
  GPIO_InitStruct.Pin = IN2_B_Pin|IN1_A_Pin|select_Pin|OE_hand_Pin 
                          |OE_step_drv_Pin|CTRL_Pin|EN_Pin|CS_Pin 
                          |WP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
