...
// FILE: motor.h
//
class soft_stepper : public base_motor {
 public:
  soft_stepper(TIM_HandleTypeDef *tim_1, TIM_HandleTypeDef *tim_2, TIM_HandleTypeDef *freqSteps, TIM_HandleTypeDef *encTim);
  soft_stepper(TIM_HandleTypeDef *tim_1, TIM_HandleTypeDef *tim_2, TIM_HandleTypeDef *freqSteps, TIM_HandleTypeDef *encTim, dir direction, step stepmode, unsigned int accel);
  ~soft_stepper();
 ...
 private:
  ...
  uint32_t stepsForAccel = 100;
  uint32_t iterationsForFullAccel = 0;
